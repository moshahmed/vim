" Usage: vim thisfile, :so % .. to use xterm colors by name.
...
hi x239_Grey31               ctermfg=239 guifg=#4e4e4e
hi x240_Grey34               ctermfg=240 guifg=#585858
...
hi x252_Grey81               ctermfg=252 guifg=#d0d0d0
hi x253_Grey85               ctermfg=253 guifg=#dadada
hi x254_Grey90               ctermfg=254 guifg=#e4e4e4
