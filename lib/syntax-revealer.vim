" What: hilinks.vim: trace links of highlighting groups
" Usage:so % |:HLT or :HLTm
" vim:ts=4:
...
:amenu    Mo1.Syn.SyntaxRevealer.HLT   :HLT<CR>
:amenu    Mo1.Syn.SyntaxRevealer.HLTm  :HLTm<CR> 
