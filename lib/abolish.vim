" what: :%Subvert/{,un}nec{ce,ces,e}sar{y,ily}/{}nec{es}sar{}/g
" from https://github.com/tpope/vim-abolish
" 2017-05-23 
let g:abolish_save_file=expand("~/.vim_abolish_save")
...
" Example from abolish.doc
" :%Subvert/{,un}nec{ce,ces,e}sar{y,ily}/{}nec{es}sar{}/g
" Unneccessarily
" Unneccessary
